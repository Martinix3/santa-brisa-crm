...
import type { TeamMember, Account, InventoryItem } from "@/types";
...
import { AccountFormValues, accountSchema } from "@/lib/schemas/account-schema";
...
export function AccountFormCore({
  onSubmit,
  onCancel,
  defaultValues,
  teamMembers,
  ...
  const form = useForm<AccountFormValues>({
    ...
    defaultValues: {
      ...
      accountType: 'HORECA',
      ...defaultValues,
      salesRepId: defaultValues?.salesRepId || user?.id,
    },
  });
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-end gap-2 pt-2">
        ...
        <Button type="submit" disabled={isSaving} className="bg-[var(--sb-primary)] text-zinc-900 hover:brightness-95">
