...
interface DirectSaleShippingLabelDialogProps {
...
export default function DirectSaleShippingLabelDialog({ sale, account, isOpen, onOpenChange }: DirectSaleShippingLabelDialogProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md shipping-label-dialog">
        <DialogHeader className="print-hide">
          <DialogTitle>Etiqueta de Envío para Venta {sale.id.substring(0, 8)}...</DialogTitle>
        </DialogHeader>
        ...
        <div id="shipping-label-content" className="shipping-label-dialog-content my-4">
            ...
            <p className="font-bold text-xl mb-4">{sale.customerName}</p>
            ...
            <div className="mt-6 pt-4 border-t">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                    Ref. Factura: {sale.invoiceNumber || `Venta ID: ${sale.id.substring(0,8)}...`}
                </p>
            </div>
        </div>
