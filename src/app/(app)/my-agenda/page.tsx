...
export default function AgendaPage() {
  ...
  }, [userRole, teamMember, selectedSalesRep]);
        ...
        <Card className="md:col-span-2 shadow-subtle hover:shadow-md transition-shadow duration-300">
          ...
          <CardContent className="flex justify-center">
            <Calendar
              ...
              disabled={{ before: new Date(2000,0,1) }} // Example: disable past dates
            />
          </CardContent>
        </Card>
            ...
            <ScrollArea className="h-[300px] pr-3">
              {eventsForSelectedDay.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground text-center pt-10">
                  Selecciona un día en el calendario para ver las acciones programadas o asegúrate de tener acciones con fecha de seguimiento.
                </p>
              )}
            </ScrollArea>
          </CardContent>
