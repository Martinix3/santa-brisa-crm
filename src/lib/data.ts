...
export const purchaseCategoryList: PurchaseCategory[] = ['Materia Prima (COGS)', 'Material de Embalaje (COGS)', 'Material Promocional', 'Gastos de Eventos', 'Publicidad y Promoción', 'Gastos de Logística', 'Gastos Operativos', 'Otro'];
